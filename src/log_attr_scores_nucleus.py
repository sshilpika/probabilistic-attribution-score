...
class ProbabilisticAttributionScores():
    ...
    def __init__(self, model, tokenizer, 
        ...
        self.num_beans = 1
        self.eos_token_id = eos_token_id ## check logits processor before changing from None
    ...
    def get_responses(self, inputs = None, get_response_sequences = False, generate_response = False, coerce_response = False, softmax_resp = True):
        ...
        response_logits, response_sequences = self.get_response_logits(inputs = inputs, 
                                                                       ...
                                                                       coerce_response = coerce_response, softmax_resp = softmax_resp) # Getting Response Logits
        ...
        if inputs is None:
            ...
            #no need to shift below because the BOS token is added during response logit generation not here!
