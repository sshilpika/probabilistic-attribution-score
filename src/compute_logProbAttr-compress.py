...
if __name__ == "__main__":
    ...
    try:
        for s_id, prompt in enumerate(prompts):
            ...
            print("response --- ",response, pa.ori_response)
            ...
            for mu in range(first_mu, input_token_len):
                ...
                # (optional if iterated in micro-batches) make one tensor on each rank
                ...
                if distributed_state.is_main_process:
                    ...
                    #model_name, prompt, response, muid, mu_val, D, D_num, D_denom, A_num, LogA
