...
class ProbabilisticAttributionScores():
    ...
    def get_input_logits(self, inputs = None):
        ...
        return input_logits[:,:-1,:] # input_logits[:,:-1,:] -1 removes the output token
        
        
    def get_responses(self, inputs = None, get_response_sequences = False, generate_response = False, coerce_response = False):
        # This function returns the response logits, input logits and the input tokenids
    ...
    def prefix_allowed_tokens_fn(self, batch_id, generated_ids): 
        """
